      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-16 pt-10">
        ...
        <section className="mt-10 grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
          ...
          <aside className="rounded-3xl border border-[#d4d0c4] bg-white/85 p-6 shadow-2 backdrop-blur">
            <div className="text-xs font-semibold uppercase tracking-[0.2em] text-[#687269]">MVP includes</div>
        ...
        <section className="mt-12">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ...
              <article key={item.title} className="rounded-3xl border border-[#d4d0c4] bg-white/90 p-5 shadow-1">
                <h2 className="text-lg font-semibold text-[#2d3a33]">{item.title}</h2>
        ...
        <section className="mt-12 rounded-3xl border border-[#d4d0c4] bg-white/90 p-6 shadow-2">
          <div className="text-xs font-semibold uppercase tracking-[0.22em] text-[#687269]">How it works</div>
          <div className="mt-4 grid gap-4 md:grid-cols-3">
            {[
              ...
              <div key={step} className="rounded-2xl border border-[#e1ddd2] bg-[#f9f8f4] p-4">
                ...
                <div className="mt-2 text-base font-semibold text-[#2d3a33]">{title}</div>
        ...
        <section className="mt-12 rounded-3xl border border-[#2d3a33]/10 bg-[#2d3a33] p-8 text-white shadow-2">
          <div className="max-w-3xl">
            <div className="text-xs font-semibold uppercase tracking-[0.2em] text-[#d3ddd2]">Join the platform</div>
            <h2 className="mt-3 text-3xl font-semibold sm:text-4xl">
              Build your next content system around ideas, not chaos.
            </h2>
            <p className="mt-3 text-sm text-[#d5ddd6] sm:text-base">
              This MVP is designed for creators and teams who need a faster path from thought to publish-ready output.
              Start free, map your first campaign, and invite your workflow into a more visual process.
            </p>
